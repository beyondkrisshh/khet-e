...
import FarmerRegistration from "./SignUpUtility/Farmer/FarmerDetails1/FarmerRegistration";
import BuyerRegistration from "./SignUpUtility/Buyer/BuyerDetailsI/BuyerRegistration";
...
function Signup() {
    ...
    const handleDataFromChild = (accountName) => {
        setDataFromChild(accountName);
                        ...
                        <main className={styles.signupContainer}>
                            <section className={styles.contentWrapper}>
                                ...
                                <AccountTypeSelector
                                    ...
                                    // accountDataUpdate={handleDataFromChild}
                                />
                                {/* <ContinueButton /> */}
                    ...
                    <>
                        <main className={styles.landWrapper}>
                            ...
                            <form className={styles.formContainer}>
                                ...
                                <label className={styles.cropType}>
                                    Type of crop
                                </label>
